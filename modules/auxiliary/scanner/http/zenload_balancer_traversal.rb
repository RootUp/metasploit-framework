...
class MetasploitModule < Msf::Auxiliary
  ...
  def initialize(info={})
    super(update_info(info,
      ...
      'Description'    => %q{
          This module exploits a directory traversal vulnerablity in zen load balancer
          v3.10.1. The flaw exists in 'index.cgi' not properly handling 'filelog=' parameter,
          which allows a malcious actor to load arbitrary file path.
      },
      'License'        => MSF_LICENSE,
      'Author'         =>
        [
